 ...
 */
(function(a,b){if(typeof exports==="object"&&exports){module.exports=b}else{if(typeof define==="function"&&define.amd){define(b)}else{a.Mustache=b}}}(this,(function(){var v={};v.name="mustache.js";v.version="0.7.2";v.tags=["{{","}}"];v.Scanner=t;v.Context=r;v.Writer=p;var d=/\s*/;var k=/\s+/;var h=/\S/;var g=/\s*=/;var m=/\s*\}/;var s=/#|\^|\/|>|\{|&|=|!/;var i=RegExp.prototype.test;var u=Object.prototype.toString;function n(y,x){return i.call(y,x)}function f(x){return !n(h,x)}var j=Array.isArray||function(x){return u.call(x)==="[object Array]"};function e(x){return x.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,"\\$&")}var c={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;"};function l(x){return String(x).replace(/[&<>"'\/]/g,function(y){return c[y]})}v.escape=l;function t(x){this.string=x;this.tail=x;this.pos=0}t.prototype.eos=function(){return this.tail===""};t.prototype.scan=function(y){var x=this.tail.match(y);if(x&&x.index===0){this.tail=this.tail.substring(x[0].length);this.pos+=x[0].length;return x[0]}return""};t.prototype.scanUntil=function(y){var x,z=this.tail.search(y);switch(z){case -1:x=this.tail;this.pos+=this.tail.length;this.tail="";break;case 0:x="";break;default:x=this.tail.substring(0,z);this.tail=this.tail.substring(z);this.pos+=z}return x};function r(x,y){this.view=x;this.parent=y;this._cache={}}r.make=function(x){return(x instanceof r)?x:new r(x)};r.prototype.push=function(x){return new r(x,this)};r.prototype.lookup=function(x){var A=this._cache[x];if(!A){if(x=="."){A=this.view}else{var z=this;while(z){if(x.indexOf(".")>0){A=z.view;var B=x.split("."),y=0;while(A&&y<B.length){A=A[B[y++]]}}else{A=z.view[x]}if(A!=null){break}z=z.parent}}this._cache[x]=A}if(typeof A==="function"){A=A.call(this.view)}return A};function p(){this.clearCache()}p.prototype.clearCache=function(){this._cache={};this._partialCache={}};p.prototype.compile=function(z,x){var y=this._cache[z];if(!y){var A=v.parse(z,x);y=this._cache[z]=this.compileTokens(A,z)}return y};p.prototype.compilePartial=function(y,A,x){var z=this.compile(A,x);this._partialCache[y]=z;return z};p.prototype.getPartial=function(x){if(!(x in this._partialCache)&&this._loadPartial){this.compilePartial(x,this._loadPartial(x))}return this._partialCache[x]};p.prototype.compileTokens=function(z,y){var x=this;return function(A,C){if(C){if(typeof C==="function"){x._loadPartial=C}else{for(var B in C){x.compilePartial(B,C[B])}}}return o(z,x,r.make(A),y)}};p.prototype.render=function(z,x,y){return this.compile(z)(x,y)};function o(E,y,x,H){var B="";var z,F,G;for(var C=0,D=E.length;C<D;++C){z=E[C];F=z[1];switch(z[0]){case"#":G=x.lookup(F);if(typeof G==="object"){if(j(G)){for(var A=0,J=G.length;A<J;++A){B+=o(z[4],y,x.push(G[A]),H)}}else{if(G){B+=o(z[4],y,x.push(G),H)}}}else{if(typeof G==="function"){var I=H==null?null:H.slice(z[3],z[5]);G=G.call(x.view,I,function(K){return y.render(K,x)});if(G!=null){B+=G}}else{if(G){B+=o(z[4],y,x,H)}}}break;case"^":G=x.lookup(F);if(!G||(j(G)&&G.length===0)){B+=o(z[4],y,x,H)}break;case">":G=y.getPartial(F);if(typeof G==="function"){B+=G(x)}break;case"&":G=x.lookup(F);if(G!=null){B+=G}break;case"name":G=x.lookup(F);if(G!=null){B+=v.escape(G)}break;case"text":B+=F;break}}return B}function w(D){var y=[];var C=y;var E=[];var A;for(var z=0,x=D.length;z<x;++z){A=D[z];switch(A[0]){case"#":case"^":E.push(A);C.push(A);C=A[4]=[];break;case"/":var B=E.pop();B[5]=A[2];C=E.length>0?E[E.length-1][4]:y;break;default:C.push(A)}}return y}function a(C){var z=[];var B,y;for(var A=0,x=C.length;A<x;++A){B=C[A];if(B){if(B[0]==="text"&&y&&y[0]==="text"){y[1]+=B[1];y[3]=B[3]}else{y=B;z.push(B)}}}return z}function q(x){return[new RegExp(e(x[0])+"\\s*"),new RegExp("\\s*"+e(x[1]))]}v.parse=function(O,D){O=O||"";D=D||v.tags;if(typeof D==="string"){D=D.split(k)}if(D.length!==2){throw new Error("Invalid tags: "+D.join(", "))}var H=q(D);var z=new t(O);var F=[];var E=[];var C=[];var P=false;var N=false;function M(){if(P&&!N){while(C.length){delete E[C.pop()]}}else{C=[]}P=false;N=false}var A,y,G,I,B;while(!z.eos()){A=z.pos;G=z.scanUntil(H[0]);if(G){for(var J=0,K=G.length;J<K;++J){I=G.charAt(J);if(f(I)){C.push(E.length)}else{N=true}E.push(["text",I,A,A+1]);A+=1;if(I=="\n"){M()}}}if(!z.scan(H[0])){break}P=true;y=z.scan(s)||"name";z.scan(d);if(y==="="){G=z.scanUntil(g);z.scan(g);z.scanUntil(H[1])}else{if(y==="{"){G=z.scanUntil(new RegExp("\\s*"+e("}"+D[1])));z.scan(m);z.scanUntil(H[1]);y="&"}else{G=z.scanUntil(H[1])}}if(!z.scan(H[1])){throw new Error("Unclosed tag at "+z.pos)}B=[y,G,A,z.pos];E.push(B);if(y==="#"||y==="^"){F.push(B)}else{if(y==="/"){if(F.length===0){throw new Error('Unopened section "'+G+'" at '+A)}var x=F.pop();if(x[1]!==G){throw new Error('Unclosed section "'+x[1]+'" at '+A)}}else{if(y==="name"||y==="{"||y==="&"){N=true}else{if(y==="="){D=G.split(k);if(D.length!==2){throw new Error("Invalid tags at "+A+": "+D.join(", "))}H=q(D)}}}}}var x=F.pop();if(x){throw new Error('Unclosed section "'+x[1]+'" at '+z.pos)}E=a(E);return w(E)};var b=new p();v.clearCache=function(){return b.clearCache()};v.compile=function(y,x){return b.compile(y,x)};v.compilePartial=function(y,z,x){return b.compilePartial(y,z,x)};v.compileTokens=function(y,x){return b.compileTokens(y,x)};v.render=function(z,x,y){return b.render(z,x,y)};v.to_html=function(A,y,z,B){var x=v.render(A,y,z);if(typeof B==="function"){B(x)}else{return x}};return v}())));var NGC={};NGC.viewmodel={};NGC.view={};NGC.templates={};(function(b,a){a.config={};b.extend(a.config,{data:{points:{checked:{name:"Проверенные",createIcon:function(){return a.map.getIcon("entity-checked",20)},createLayer:function(){return new L.MarkerClusterGroup({disableClusteringAtZoom:17,iconCreateFunction:function(c){return new L.DivIcon({html:"<div><span>"+c.getChildCount()+"</span></div>",className:"marker-cluster marker-cluster-small",iconSize:new L.Point(40,40)})}})},searchCssClass:"checked",z:1},unchecked:{name:"Непроверенные",createIcon:function(){return a.map.getIcon("entity-unchecked",20)},createLayer:function(){return new L.MarkerClusterGroup({disableClusteringAtZoom:17,iconCreateFunction:function(c){return new L.DivIcon({html:"<div><span>"+c.getChildCount()+"</span></div>",className:"marker-cluster marker-cluster-medium",iconSize:new L.Point(40,40)})}})},searchCssClass:"non-checked",z:2},blocked:{name:"Заблокированные",createIcon:function(){return a.map.getIcon("entity-blocked",20)},createLayer:function(){return new L.MarkerClusterGroup({disableClusteringAtZoom:17,iconCreateFunction:function(c){return new L.DivIcon({html:"<div><span>"+c.getChildCount()+"</span></div>",className:"marker-cluster marker-cluster-large",iconSize:new L.Point(40,40)})}})},searchCssClass:"blocked",z:3}}}})})(jQuery,NGC);(function(b,a){b.extend(a.viewmodel,{version:null});b.extend(a.view,{$document:null});a.loader={};b.extend(a.loader,{templates:["entityPopupTemplate","entityPopupInfoTemplate","searchResultsTemplate","userLogsTemplate","alertsTemplate"],init:function(){var c=this;this.setDomOptions();window.setTimeout(function(){c.initModules();b("img").imagesLoaded(function(){a.view.$body.removeClass("loading")});a.alerts.showAlert("historyShortcuts")},1000)},initModules:function(){a.common.init();a.popup.init();a.alerts.init();a.permalink.init();a.map.init();a.geocoder.init();a.searcher.init();a.searcher.address.init();a.searcher.tab.init();a.editor.init();a.user.init();a.entities.init();a.josm.init();a.editor.tab.init();a.versions.init()},setDomOptions:function(){a.view.$document=b(document)}});b(document).ready(function(){a.loader.init()})})(jQuery,NGC);(function(a,c){var b;NGC.subscriber={};b=NGC.subscriber;c.extend(NGC.subscriber,{isLog:false,routes:{},$document:c(document),subscribe:function(f,g,e){var d={callback:g,context:e};if(!b.routes[f]){b.routes[f]=[d]}else{b.routes[f].push(d)}},publish:function(g,f){var e,h=0,d;f=f||[];b.trigger(g,f);if(!b.routes.hasOwnProperty(g)){return false}for(h,d=b.routes[g].length;h<d;h+=1){e=b.routes[g][h];e.callback.apply(e.context,f)}},unsubscribe:function(d){delete b.routes[d]},call:function(f,e){e=e||[];if(!b.routes.hasOwnProperty(f)){return false}var d=b.routes[f][0];return d.callback.apply(d.context,e)},trigger:function(e,d){d=d||[];b.$document.trigger(e,d)}});NGC.subscribe=NGC.subscriber.subscribe;NGC.unsubscribe=NGC.subscriber.unsubscribe;NGC.publish=NGC.subscriber.publish;NGC.call=NGC.subscriber.call;NGC.trigger=NGC.subscriber.trigger})(NGC,jQuery);(function(b,a){a.helpers={};b.extend(a.helpers,{getIcon:function(d,c){return L.divIcon({className:d,iconSize:[c,c],iconAnchor:[c/2,c/2],popupAnchor:[0,2-(c/2)]})},hashToArrayKeyValues:function(d){var c=[];if(Object.prototype.toString.call(d)==="[object Array]"){return d}for(var e in d){if(!d.hasOwnProperty(e)){continue}c.push({key:e,val:d[e]})}return c},boolToString:function(d,c){switch(d){case null:return c?"null":"";break;case true:return c?"true":"Да";break;case false:return c?"false":"Нет";break}throw"The bool value is not convertible to string"},valueNullToString:function(c){if(c===null){return""}return c},sortByFields:function(){var d=arguments,c=this;return function(j,h){var f=0,e=0,g=d.length;while(e===0&&f<g){e=c.dynamicSort(d[f])(j,h);f++}return e}},dynamicSort:function(d){var c=1;if(d[0]==="-"){c=-1;d=d.substr(1,d.length-1)}return function(g,f){var e=(g[d]<f[d])?-1:(g[d]>f[d])?1:0;return e*c}},getURLParameter:function(c){return decodeURI((RegExp(c+"=(.+?)(&|$)").exec(location.search)||[,null])[1])}})})(jQuery,NGC);(function(b,a){b.extend(a.view,{$body:null});a.common={};b.extend(a.common,{init:function(){this.setDomOptions();this.bindEvents()},bindEvents:function(){a.view.$document.on("/ngc/common/setMainLoad",function(){a.view.$body.addClass("loader")});b("div.help-panel div.help").off("click").on("click",function(){a.view.$document.trigger("/ngc/popup/openPopup",["Добро пожаловать!",a.templates.welcomeTemplate({rootUrl:document.url_root})])})},setDomOptions:function(){a.view.$body=b("body")}})})(jQuery,NGC);(function(b,a){b.extend(a.view,{$popup:null});a.popup={};b.extend(a.popup,{$header:null,$content:null,init:function(){this.setDomOptions();this.bindEvents()},setDomOptions:function(){var c=a.view;c.$popup=b("#popup");this.$header=c.$popup.find("div.header");this.$content=c.$popup.find("div.content")},bindEvents:function(){var c=a.view,d=this;c.$document.on("/ngc/popup/openPopup",function(h,i,g,f){d.openPopup(i,g,f)});c.$document.on("/ngc/popup/closePopup",function(){d.closePopup()});c.$popup.find("a.close").off("click").on("click",function(){d.closePopup()})},openPopup:function(i,d,g){var c=a.view,h=c.$popup,f,e;this.$header.text(i);this.$content.html(d);f=h.width()/2;e=h.height()/2;h.css({"margin-left":-f+"px","margin-top":-e+"px"});c.$body.addClass("popup");c.$document.trigger("/ngc/popup/"+g+"/opened")},closePopup:function(){a.view.$body.removeClass("popup")}})})(jQuery,NGC);(function(b,a){b.extend(a.viewmodel,{map:null,mapLayers:{},isPopupOpened:false});b.extend(a.view,{$map:null});a.map={};b.extend(a.map,{init:function(){this.bindTriggers();this.buildMap();this.buildLayerManager();this.buildLayers();this.bindMapEvents()},bindTriggers:function(){var d=this,c=a.view,e=a.viewmodel;a.subscribe("/ngc/map/setView",function(g,f){e.map.setView(g,f);d.setLastExtentToCookie(g,f);c.$document.trigger("/ngc/permalink/update",[e.map.getCenter(),e.map.getZoom()])});c.$document.on("/ngc/map/updateAllLayers",function(){a.view.$document.trigger("/ngc/entities/update")});a.subscribe("/ngc/map/openPopup",function(h,f){var g=a.viewmodel.map;g.panTo(h);g.openPopup(L.popup({maxHeight:300,minWidth:300}).setLatLng(h).setContent(f))})},buildMap:function(){var d=a.viewmodel,c;a.view.$map=b("#map");d.map=new L.Map("map");this.initUrlModule();this.initHistoryModule();L.control.scale().addTo(d.map);c=L.layerGroup();d.map.addLayer(c);d.mapLayers.select=c},buildLayers:function(){var f=a.config.data.points,c,e,d={},g=[];a.viewmodel.mapLayers.points={};for(c in f){if(f.hasOwnProperty(c)){e=f[c].createLayer();a.viewmodel.map.addLayer(e);a.viewmodel.mapLayers.points[c]=e;d[f[c].z]=c;g.push(f[c].z)}}g.sort(function(i,h){return h-i});b.each(g,function(h,j){a.viewmodel.mapLayers.points[d[j]].bringToFront()})},bindMapEvents:function(){var c=this,d=a.viewmodel;d.map.on("moveend",function(i){var h=i.target,f=h.getCenter(),g=h.getZoom();c.setLastExtentToCookie(f,g);a.map.pushCurrentExtent();a.view.$document.trigger("/ngc/permalink/update",[f,g]);a.view.$document.trigger("/ngc/map/updateAllLayers")});d.map.on("popupclose",function(){var e=a.viewmodel;e.isPopupOpened=false;e.mapLayers.select.clearLayers()})},setLastExtentToCookie:function(d,c){b.cookie("map.lat",d.lat,{expires:7,path:"/"});b.cookie("map.lng",d.lng,{expires:7,path:"/"});b.cookie("map.zoom",c,{expires:7,path:"/"})}})})(jQuery,NGC);(function(b,a){b.extend(a.viewmodel,{});b.extend(a.view,{});b.extend(a.map,{defaultExtent:{latlng:new L.LatLng(55.773121344534445,37.66945838928223),zoom:14},initUrlModule:function(){var c=this.getExtentFromUrl();if(c){a.call("/ngc/map/setView",[c.latlng,c.zoom])}else{lastExtent=this.getLastExtentFromCookie();if(lastExtent){a.call("/ngc/map/setView",[lastExtent.latlng,lastExtent.zoom])}else{a.call("/ngc/map/setView",[this.defaultExtent.latlng,this.defaultExtent.zoom])}}},getExtentFromUrl:function(){var e=a.helpers,f=parseFloat(e.getURLParameter("lat")),c=parseFloat(e.getURLParameter("lon")),d=parseFloat(e.getURLParameter("zoom"));if(f&&c&&d){return{latlng:new L.LatLng(f,c),zoom:d}}return null},getLastExtentFromCookie:function(){var e=parseFloat(b.cookie("map.lat"),10),c=parseFloat(b.cookie("map.lng"),10),d=parseInt(b.cookie("map.zoom"),10);if(e&&c&&d){return{latlng:new L.LatLng(e,c),zoom:d}}else{return null}}})})(jQuery,NGC);(function(b,a){b.extend(a.viewmodel,{});b.extend(a.view,{});b.extend(a.map,{lockHistory:false,extentHistory:[],extentHistoryPointer:-1,initHistoryModule:function(){this.bindEvents();this.pushCurrentExtent()},bindEvents:function(){var c=this;a.view.$map.keydown(function(d){if(d.keyCode===80){c.backwardExtentHistory()}if(d.keyCode===78){c.forwardExtentHistory()}})},pushCurrentExtent:function(){var c=[a.viewmodel.map.getCenter(),a.viewmodel.map.getZoom()];if(this.extentHistoryPointer>=0&&this.extentHistory[this.extentHistoryPointer][0].lat===c[0].lat&&this.extentHistory[this.extentHistoryPointer][0].lng===c[0].lng&&this.extentHistory[this.extentHistoryPointer][1]===c[1]){return false}while(this.extentHistory.length-1>this.extentHistoryPointer){this.extentHistory.pop()}this.extentHistory.push(c);this.extentHistoryPointer++},backwardExtentHistory:function(){var c;if(this.extentHistoryPointer>0){this.extentHistoryPointer-=1;c=this.extentHistory[this.extentHistoryPointer];this.lockHistory=true;a.viewmodel.map.setView(c[0],c[1]);this.lockHistory=false}},forwardExtentHistory:function(){var c;if(this.extentHistoryPointer+1<this.extentHistory.length){this.extentHistoryPointer+=1;c=this.extentHistory[this.extentHistoryPointer];this.lockHistory=true;a.viewmodel.map.setView(c[0],c[1]);this.lockHistory=false}}})})(jQuery,NGC);(function(b,a){b.extend(a.map,{getIcon:function(d,c){return L.divIcon({className:d,iconSize:[c,c],iconAnchor:[c/2,c/2],popupAnchor:[0,2-(c/2)]})}})})(jQuery,NGC);(function(b,a){b.extend(a.viewmodel,{currentTileLayer:null});b.extend(a.view,{$tileLayers:null,$manager:null});b.extend(a.map,{_layers:{},_lastIndex:0,buildLayerManager:function(){var c=a.view;a.view.$manager=b("#manager");this.addTileLayer("osm","http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png","© OpenStreetMap contributors");this.addTileLayer("irs","http://irs.gis-lab.info/?layers=irs&request=GetTile&z={z}&x={x}&y={y}","Kosmosnimki.ru IRS");this.addBingLayer("AujH--7B6FRTK8b81QgPhuvw_Sb3kc8hBO-Lp5OLNyhCD4ZQoGGW4cQS6zBgaeEh");a.view.$tileLayers=c.$map.find("div.leaflet-tile-pane div.leaflet-layer");this.bindLayerManagerEvents();this.onLayer("osm")},bindLayerManagerEvents:function(){var c=this;a.viewmodel.map.off("zoomend").on("zoomend",function(){c.onLayer()});a.view.$manager.find("div.tile-layers div.icon").off("click").on("click",function(d){c.onLayer(b(this).data("layer"))})},onLayer:function(e){var d=a.viewmodel,c=a.view,f=b(d.map.getPanes().tilePane).find("div.leaflet-layer");if(e){c.$body.removeClass(d.currentTileLayer).addClass(e);if(d.currentTileLayer){d.map.removeLayer(this._layers[d.currentTileLayer].layer)}d.currentTileLayer=e;d.map.addLayer(this._layers[e].layer,true)}else{}},addTileLayer:function(f,d,c){var e=new L.TileLayer(d,{minZoom:8,maxZoom:18,attribution:c});this._layers[f]={layer:e,index:this._lastIndex};this._lastIndex+=1},addBingLayer:function(d){var c=new L.BingLayer(d,{minZoom:8,maxZoom:18});this._layers.bing={layer:c,index:this._lastIndex};this._lastIndex+=1}})})(jQuery,NGC);(function(b,a){b.extend(a.viewmodel,{});b.extend(a.view,{});a.geocoder={};b.extend(a.geocoder,{init:function(){this.bindEvents()},bindEvents:function(){},directGeocode:function(d,e){var c="http://openstreetmap.ru/api/search?callback=?&q="+d;b.ajax({type:"GET",url:c,async:false,jsonpCallback:"jsonCallback",contentType:"application/json",dataType:"jsonp",success:function(f){e(f)}})}})})(jQuery,NGC);(function(b,a){b.extend(a.viewmodel,{searcherCollapsed:false,filter:{},isFilterValidated:true});b.extend(a.view,{$searchContainer:null,$filterName:null,$filterAddr:null,$searchButton:null,$entitiesSearchResults:null,$clearSearch:null});a.searcher={};b.extend(a.searcher,{min_characters_count:3,init:function(){this.setDomOptions();this.initFilter();this.bindEvents()},setDomOptions:function(){var c=a.view;c.$searchContainer=b("#searchContainer");c.$filterName=b("#filter_name");c.$filterAddr=b("#filter_address");c.$searchButton=b("#search");c.$entitiesSearchResults=b("#searchEntity").find("div.searchResults");c.$clearSearch=c.$searchContainer.find("a.clear-search")},initFilter:function(){var g=this,e=a.view,f,d,i,c,j,h;e.$searchContainer.find("div.search-block").each(function(k){f=b(this);d=f.data("filter");h=a.viewmodel.filter;h[d]={};h[d].json={};h[d].is_valid=true;h[d].trigger=f.data("trigger");h[d].btn_search=f.find("div.search");h[d].clear_search=f.find("a.clear-search");h[d].elements={};f.find("input.filterable").each(function(){(function(l,n,m){i=b(l);c=i.data("filter");a.viewmodel.filter[n].elements[c]={element:i,is_valid:true};m[n].json[c]=""})(this,d,h)})})},bindEvents:function(){var c=a.view,d=this;this.bindKeyUpHandlers();c.$searchContainer.find("span.icon-collapse, div.title").off("click").on("click",function(){a.viewmodel.searcherCollapsed=!a.viewmodel.searcherCollapsed;a.view.$body.toggleClass("searcher-collapsed",d.searcherCollapsed)});c.$document.on("/sm/searcher/update",function(){d.updateSearch()})},bindKeyUpHandlers:function(){var e=this,d=a.viewmodel.filter,f,i,g,k,j,c,h;for(i in d){if(d.hasOwnProperty(i)){f=d[i];for(k in f.elements){if(f.elements.hasOwnProperty(k)){g=f.elements[k].element;(function(n,l,m){n.off("keyup").on("keyup",function(o){h=b(this);if(o.keyCode===13){if(m.validateFilter(l)){m.applyFilter(l)}}else{j=m[h.data("validate")](h.val());h.toggleClass("invalid",!j);k=h.data("filter");l.elements[k].is_valid=j;c=m.validateFilter(l);l.btn_search.toggleClass("active",c);if(c){m.buildFilterJson(l)}if(c&&m.isEmptyFilters(l)){l.btn_search.removeClass("active")}}});l.clear_search.off("click").on("click",function(){b.each(l.elements,function(){this.element.val("")});m.applyFilter(l)});l.btn_search.off("click").on("click",function(){if(b(this).hasClass("active")){m.applyFilter(l)}})})(g,f,e)}}}}},validateFilter:function(c){var e=c.elements,d;for(d in e){if(e.hasOwnProperty(d)&&!e[d].is_valid){c.is_valid=false;return false}}c.is_valid=true;return true},isEmptyFilters:function(d){var e=d.elements,c;for(c in e){if(e.hasOwnProperty(c)){if(b.trim(e[c].element.val())!==""){return false}}}return true},validateDefault:function(d){var c=b.trim(d);return c.length>this.min_characters_count||c===""},validateNumber:function(c){return true},applyFilter:function(c){this.buildFilterJson(c);this.search(c)},buildFilterJson:function(d){var e=d.elements,c;for(c in e){if(e.hasOwnProperty(c)){d.json[c]=b.trim(e[c].element.val())}}},search:function(c){a.view.$document.trigger(c.trigger)},updateSearch:function(){var d=a.viewmodel.pointLayers.entities,c=a.config.data.points,g,f=a.view.$entitiesSearchResults.find("div"),e;f.empty();for(g in d){if(d.hasOwnProperty(g)){e=this.getHtmlForSearchResults(c[g].searchCssClass,d[g].elements);f.append(e)}}f.find("a.target").on("click",function(){var h=b(this).parent();a.viewmodel.map.setView(new L.LatLng(h.data("lat"),h.data("lon")),18);b("#target").show().delay(1000).fadeOut(1000)});f.find("a.edit").on("click",function(){if(a.viewmodel.editable){return false}var i=b(this).parent(),h;a.viewmodel.map.setView(new L.LatLng(i.data("lat"),i.data("lon")),18);b("#target").show().delay(1000).fadeOut(1000);h=i.data("id");b.getJSON(document.url_root+"entity/"+h,function(j){if(!a.viewmodel.editable){a.viewmodel.entitySelected=j;a.view.$document.trigger("/ngc/editor/startEdit")}})});f.prop("class","active")},getHtmlForSearchResults:function(c,d){return a.templates.searchResultsTemplate({cssClass:c,entities:d,isAuth:a.viewmodel.isAuth})}})})(jQuery,NGC);(function(b,a){b.extend(a.viewmodel,{});b.extend(a.view,{$divAddressSearchResults:null});a.searcher.address={};b.extend(a.searcher.address,{init:function(){this.setDomOptions();this.bindEvents()},setDomOptions:function(){a.view.$divAddressSearchResults=b("#searchAddress").find("div.searchResults div")},bindEvents:function(){var c=this;a.view.$document.on("/ngc/search/address",function(){c.searchAddress()})},searchAddress:function(){var d=this,c=a.view.$divAddressSearchResults,e;c.empty();a.geocoder.directGeocode(a.viewmodel.filter.address.json.address,function(f){e=f.matches;c.append(d.getHtmlForSearchResults("",e));c.find("a.target").on("click",function(){var g=b(this).parent();a.viewmodel.map.setView(new L.LatLng(g.data("lat"),g.data("lon")),16);b("#target").show().delay(1000).fadeOut(1000)})})},getHtmlForSearchResults:function(c,d){return a.templates.addressSearchTemplate({cssClass:c,matches:d})}})})(jQuery,NGC);(function(b,a){b.extend(a.viewmodel,{});b.extend(a.view,{$activatedSearchTab:null});a.searcher.tab={};b.extend(a.searcher.tab,{init:function(){this.setDomOptions();this.bindEvents()},setDomOptions:function(){a.view.$activatedSearchTab=a.view.$searchContainer.find("ul.nav li.active")},bindEvents:function(){var c=this,d;a.view.$searchContainer.find("ul.nav li").off("click").on("click",function(f){d=b(this);if(d.data("id")!==a.view.$activatedSearchTab.data("id")){c.activateTab(d)}})},activateTab:function(d){var c=a.view;c.$activatedSearchTab.removeClass("active");c.$activatedSearchTab=d.addClass("active");c.$searchContainer.attr("class",d.data("id"))}})})(jQuery,NGC);(function(b,a){b.extend(a.viewmodel,{editorCollapsed:false,editable:false,latlngEditable:{lat:{validated:null,marker:null,editor:null},lng:{validated:null,marker:null,editor:null},isNeedApplied:false,sourceCoordinates:null},markerEditable:null});b.extend(a.view,{$editorContainer:null});a.editor={};b.extend(a.editor,{regex:{url:new RegExp("(https?)://[-A-Za-z0-9+&@#/%?=~_|!:,.;]*[-A-Za-z0-9+&@#/%=~_|]")},precisionDegree:6,templates:{notEditableValue:Mustache.compile("<p>{{value}}</p>")},init:function(){this.setDomOptions();this.buildEditLayer();this.bindEvents()},setDomOptions:function(){a.view.$editorContainer=b("#editorContainer");a.viewmodel.editorCollapsed=a.view.$body.hasClass("editor-collapsed")},buildEditLayer:function(){var c=L.layerGroup();a.viewmodel.mapLayers.edit=c;a.viewmodel.map.addLayer(c)},bindEvents:function(){var c=this;a.view.$editorContainer.find("span.icon-collapse, div.title").off("click").on("click",function(){c.toggleEditor()});a.view.$document.on("/ngc/editor/startEdit",function(d){c.startAjaxEdition()});b("#save").off("click").on("click",function(d){d.stopPropagation();c.save()});b("#discard").off("click").on("click",function(f){var d=a.viewmodel;f.stopPropagation();if(!d.latlngEditable.sourceCoordinates.equals(d.markerEditable.getLatLng())){d.map.setView(d.latlngEditable.sourceCoordinates,18);b("#target").show().delay(1000).fadeOut(1000)}c.finishAjaxEdition()});b("#editorForm").find(":checkbox").off("click").on("click",function(){var e=b(this),d=b("#"+e.data("id"));if(e.is(":checked")){d.val(1)}else{d.val(0)}});b("#lat, #lng").off("keyup").on("keyup",function(d){c.coordinatesInputHandler(d,b(this))});b("#applyCoordinates").off("click").on("click",function(){c.applyCoordinates(a.viewmodel.latlngEditable)});b("#undoCoordinates").off("click").on("click",function(){c.undoCoordinates()});b("#resetCenter").off("click").on("click",function(){c.resetCenter()});b("#regeocode").off("click").on("click",function(){c.regeocode()});b("#newPointCreator").off("click").on("click",function(){if(a.viewmodel.isAuth){c.createNewPoint()}else{a.alerts.showAlert("creatorFail")}})},toggleEditor:function(){var c=!a.viewmodel.editorCollapsed;a.viewmodel.editorCollapsed=c;a.view.$body.toggleClass("editor-collapsed",c)},coordinatesInputHandler:function(g,h){var c=h.attr("id"),j=h.val(),k=a.viewmodel.latlngEditable,l=k[c],d=l.validated,i=l.editor!==l.marker,f=k.isNeedApplied;if(g.keyCode===13){if(k.isNeedApplied){this.applyCoordinates(k)}}else{l.validated=this.verifyDecimalDegree(j);if(l.validated){j=parseFloat(j.replace(",",".")).toFixed(this.precisionDegree);l.editor=j}else{a.alerts.showAlert("validateCoordinatesError")}k.isNeedApplied=this.getIsCanApplied(k);if(f!==k.isNeedApplied){b("#applyCoordinates").prop("disabled",!k.isNeedApplied)}if(k.isNeedApplied){a.alerts.showAlert("changeCoordinates")}if(d!==l.validated){h.toggleClass("invalid",!l.validated)}else{if(i!==(l.editor!==l.marker)){h.toggleClass("need-apply",l.editor!==l.marker)}}}},getIsCanApplied:function(c){if(!c.lat.validated||!c.lng.validated){return false}return c.lat.editor!==c.lat.marker||c.lng.editor!==c.lng.marker},verifyDecimalDegree:function(c){return !/^\s*$/.test(c)&&!isNaN(c)},applyCoordinates:function(c){var d=a.viewmodel,e=new L.LatLng(parseFloat(c.lat.editor),parseFloat(c.lng.editor));this.updateCoordinates(e);d.markerEditable.setLatLng(e);d.map.setView(e,18);b("#target").show().delay(1000).fadeOut(1000);b("#lat, #lng").removeClass("need-apply");b("#undoCoordinates").prop("disabled",false)},undoCoordinates:function(){var c=a.viewmodel,d=new L.LatLng(c.entitySelected.obj.old_geom.lat,c.entitySelected.obj.old_geom.lng);this.updateCoordinates(d);c.markerEditable.setLatLng(d);c.map.setView(d,c.map.getZoom());b("#undoCoordinates").prop("disabled",true)},resetCenter:function(){var c=a.viewmodel.map.getCenter();this.updateCoordinates(c);a.viewmodel.markerEditable.setLatLng(c);b("#undoCoordinates").prop("disabled",false)},regeocode:function(){var d=this,f=a.viewmodel,g=a.alerts,c=b("#editorForm input[data-address-field]").val(),e;a.geocoder.directGeocode(c,function(h){if(h.find){g.showAlert("regeocodeSuccess");e=new L.LatLng(h.matches[0].lat,h.matches[0].lon);d.updateCoordinates(e);f.markerEditable.setLatLng(e);f.map.setView(e,f.map.getZoom());b("#undoCoordinates").prop("disabled",false)}else{g.showAlert("regeocodeFail")}})},startAjaxEdition:function(){var c=this;b.ajax({type:"GET",url:document.url_root+"entity/block/"+a.viewmodel.entitySelected.obj.id}).done(function(){c.startEdit()})},startEdit:function(){var d=a.viewmodel,c=a.view;c.$body.addClass("editable");if(d.editorCollapsed){this.toggleEditor()}c.$editorContainer.find("input, select, textarea, button").removeAttr("disabled");c.$editorContainer.find("form").removeClass("disabled");d.editable=true;this.startEditingGeometry(d.entitySelected.obj.geom.lat,d.entitySelected.obj.geom.lng);this.fillEditor(d.entitySelected);d.entitySelected.obj.old_geom=jQuery.extend({},d.entitySelected.obj.geom);d.map.closePopup();b("#editEntity-link").click()},startEditingGeometry:function(h,e){var f=this,d=L.marker([h,e],{icon:a.helpers.getIcon("stop-editable",25),draggable:true}),c=h.toFixed(this.precisionDegree),g=e.toFixed(this.precisionDegree);d.on("dragend",function(i){f.updateCoordinates(i.target.getLatLng());b("#undoCoordinates").prop("disabled",false)});a.viewmodel.mapLayers.edit.addLayer(d);b("#applyCoordinates").prop("disabled",true);b("#undoCoordinates").prop("disabled",true);a.viewmodel.latlngEditable={lat:{validated:true,marker:c,editor:c},lng:{validated:true,marker:g,editor:g},isNeedApplied:false,sourceCoordinates:new L.LatLng(h,e)};a.viewmodel.markerEditable=d},updateCoordinates:function(f){var h=f.lat.toFixed(this.precisionDegree),d=f.lng.toFixed(this.precisionDegree),g=a.viewmodel,c=g.latlngEditable.isNeedApplied,e=g.latlngEditable.sourceCoordinates;g.entitySelected.obj.geom.lat=f.lat;g.entitySelected.obj.geom.lng=f.lng;if(c){b("#applyCoordinates").prop("disabled",true)}g.latlngEditable={lat:{validated:true,marker:h,editor:h},lng:{validated:true,marker:d,editor:d},isNeedApplied:false,sourceCoordinates:e};b("#lat").val(h);b("#lng").val(d)},fillEditor:function(c){var d=a.helpers;b.each(c.props,function(e,f){b("#field-"+f.id).val(f.val)});if(c.obj.geom){b("#lat").val(c.obj.geom.lat);b("#lng").val(c.obj.geom.lng)}if(c.obj.approved){b("#is_applied").val(1);b("#chb_is_applied").prop("checked",true)}else{b("#is_applied").val(0);b("#chb_is_applied").prop("checked",false)}a.view.$document.trigger("/ngc/versions/build")},save:function(){if(!this.verifyEditor()){return}var g=this,h=b("#editorContainer form"),k=h.serializeArray(),d=k.length,j=a.viewmodel.entitySelected,c={id:j.obj.id},e=document.url_root+"entity/"+c.id,f=0;for(f;f<d;f+=1){c[k[f].name]=k[f].value}c.geom=j.obj.geom;b.ajax({type:"POST",url:e,data:{entity:JSON.stringify(c)}}).done(function(){a.alerts.showAlert("saveSuccessful");g.finishAjaxEdition()}).error(function(){a.alerts.showAlert("saveError")})},verifyEditor:function(){var d=true,c=a.viewmodel.latlngEditable;if(c.isNeedApplied){d=false;a.alerts.showAlert("notAppliedCoordinates")}if(!c.lat.validated||!c.lng.validated){d=false;a.alerts.showAlert("validateCoordinatesError")}return d},finishAjaxEdition:function(){var c=this;if(!a.viewmodel.entitySelected.obj.id){c.finishEditing();return false}b.ajax({type:"GET",url:document.url_root+"entity/unblock/"+a.viewmodel.entitySelected.obj.id}).done(function(){c.finishEditing()})},finishEditing:function(){var d=a.viewmodel,c=a.view;d.map.closePopup();d.mapLayers.edit.clearLayers();d.editable=false;c.$body.addClass("editable");c.$editorContainer.find("input, textarea").val("");c.$editorContainer.find("input:checkbox").prop("checked",false);c.$editorContainer.find("input, select, textarea, button").attr("disabled","disabled").removeClass("invalid");c.$editorContainer.find("form").addClass("disabled");c.$editorContainer.find("span.value").empty();a.view.$document.trigger("/ngc/versions/clearUI");a.view.$document.trigger("/ngc/map/updateAllLayers")},createNewPoint:function(){var c=a.viewmodel.map.getCenter();a.viewmodel.entitySelected=({obj:{approved:false,blocked:false,geom:{lat:c.lat,lng:c.lng}},props:[],versions:[]});this.startEdit()}})})(jQuery,NGC);(function(b,a){b.extend(a.viewmodel,{entitySelected:null,entitySelectedId:null,pointLayers:{}});b.extend(a.view,{});a.entities={};b.extend(a.entities,{init:function(){this.updatePoints();this.bindEvents();this.handleUrl()},bindEvents:function(){var c=this;a.view.$document.on("/ngc/entities/update",function(){c.updatePoints()});a.subscribe("/ngc/entities/popup/openByEntity",function(d){c.openPopupByEntity(d)})},updatePoints:function(){var c=this.validateZoom();this.clearLayers();if(!c){return}a.view.$document.trigger("/ngc/entities/startUpdate");this.updateEntitiesByAjax()},clearLayers:function(){var c=a.viewmodel.mapLayers;c.points.checked.clearLayers();c.points.unchecked.clearLayers();c.points.blocked.clearLayers()},updateEntitiesByAjax:function(){var d=this,c=document.url_root+"entity/all",e=a.viewmodel.filter,f={entity:e.entity.json};b.ajax({type:"GET",url:c,data:{bbox:JSON.stringify(a.viewmodel.map.getBounds()),center:JSON.stringify(a.viewmodel.map.getCenter()),filter:JSON.stringify(f)},dataType:"json",success:function(g){d.renderEntities(g);a.view.$document.trigger("/sm/searcher/update");a.view.$document.trigger("/sm/stops/endUpdate")},context:d})},renderEntities:function(j){var d=a.viewmodel,q=d.mapLayers.points,o=a.config.data.points,n=j.data.points.layers,p,k,m,c,l,h,g,f=a.templates.entityPopupTemplate({css:"edit"}),e=this;d.pointLayers.entities=j.data.points.layers;for(p in n){if(n.hasOwnProperty(p)){k=n[p].elements;m=n[p].count;if(m>0){l=o[p].createIcon()}for(g=0;g<m;g+=1){c=k[g];h=L.marker([c.lat,c.lon],{icon:l}).on("click",function(r){var i=r.target;a.call("/ngc/map/openPopup",[i.getLatLng(),f]);e.buildEntityPopupByClick(i.id)});h.id=c.id;q[p].addLayer(h)}}}},buildEntityPopupByClick:function(c){var d=this;return b.getJSON(document.url_root+"entity/"+c,function(e){d.setEntitySelected(e);d.buildEntityPopup(e)}).error(function(){b("#entity-popup").removeClass("loader").empty().append("Error connection")})},setEntitySelected:function(c){var d=a.viewmodel;if(!d.editable){d.entitySelected=c}},buildEntityPopup:function(c){var d=a.templates.entityPopupInfoTemplate({props:c.props,obj:c.obj,isUserEditor:a.viewmodel.isAuth,editDenied:a.viewmodel.editable||c.obj.is_blocked,isBlocked:c.obj.blocked,userBlocked:c.obj.user_blocked,isUnBlocked:c.obj.is_unblocked});b("#entity-popup").removeClass("loader").empty().append(d);b("button#edit").off("click").on("click",function(){a.view.$document.trigger("/ngc/editor/startEdit")});if(c.obj.is_unblocked){b("#unblock").off("click").on("click",function(){b.ajax({type:"GET",url:document.url_root+"entity/unblock/"+a.viewmodel.entitySelected.obj.id}).done(function(){a.viewmodel.map.closePopup();a.view.$document.trigger("/ngc/map/updateAllLayers")})})}},openPopupByEntity:function(d){var c=d.obj,f=[c.geom.lat,c.geom.lng],e=a.templates.entityPopupTemplate({css:"edit"});a.call("/ngc/map/openPopup",[f,e]);this.setEntitySelected(d);this.buildEntityPopup(d)},validateZoom:function(){if(a.viewmodel.map.getZoom()<14){a.alerts.showAlert("zoom");return false}return true}})})(jQuery,NGC);(function(b,a){b.extend(a.viewmodel,{});b.extend(a.view,{});b.extend(a.entities,{handleUrl:function(){var d=this,c=this.getEntityFromUrl();if(c){if(c.editable===true&&a.viewmodel.isAuth===true){b.when(this.getAjaxEntity(c)).then(function(e){a.call("/ngc/map/setView",[[e.obj.geom.lat,e.obj.geom.lng],17]);d.setEntitySelected(e);a.view.$document.trigger("/ngc/editor/startEdit")})}else{b.when(this.getAjaxEntity(c)).then(function(e){a.viewmodel.map.setZoom(17);a.call("/ngc/entities/popup/openByEntity",[e])})}}},getEntityFromUrl:function(){var f=a.helpers,c=f.getURLParameter("uik"),d=f.getURLParameter("reg"),e=f.getURLParameter("edit");if(c!=="null"&&d!=="null"){return{uikOfficialNumber:c,regionCode:d,editable:e==="True"||e==="true"}}return null},getAjaxEntity:function(c){return b.getJSON(document.url_root+"uik/"+c.regionCode+"/"+c.uikOfficialNumber)}})})(jQuery,NGC);(function(b,a){b.extend(a.viewmodel,{});b.extend(a.view,{});a.regions={};a.regions.colorMap={1:"#0000FF",2:"#A52A2A",3:"#D2691E",4:"#DC143C",5:"#00008B",6:"#B8860B",7:"#006400",8:"#8B008B",9:"#556B2F",10:"#FF8C00",11:"#9932CC",12:"#8B0000",13:"#9400D3",14:"#FF1493",15:"#00BFFF",16:"#B22222",17:"#228B22",18:"#FFD700",19:"#DAA520",20:"#008000",21:"#FF69B4",22:"#CD5C5C",23:"#F08080",24:"#800000",25:"#66CDAA",26:"#0000CD",27:"#BA55D3",28:"#9370DB",29:"#3CB371",30:"#7B68EE",31:"#00FA9A",32:"#48D1CC",33:"#C71585",34:"#FF00FF",35:"#FF0000",36:"#BC8F8F",37:"#4169E1",38:"#8B4513",39:"#FA8072",40:"#F4A460",41:"#2E8B57",42:"#800080",43:"#4682B4",44:"#008080",45:"#9ACD32"};b.extend(a.regions,{init:function(){this.getData()},getData:function(){var c=this,e=new b.Deferred(),d=new b.Deferred();b.ajax({dataType:"json",url:document.url_root+"static/data/mos-mo-splitted.json",success:function(f){c.buildRegionsLayer(f);e.resolve()},error:function(h,f,g){alert(h,f,g)}});b.ajax({dataType:"json",url:document.url_root+"static/data/mos-io-lines.json",success:function(f){c.buildBordersDistrictsLayer(f);d.resolve()},error:function(h,f,g){alert(h,f,g)}});b.when(e.promise(),d.promise()).then(function(){c.bindRegionLayersEvent();c.verifyLayersByZoom();a.viewmodel.map.addLayer(c.bordersDistrictsLayer)})},regionsLayer:null,buildRegionsLayer:function(c){this.regionsLayer=L.geoJson(c,{style:function(d){return{color:"#F0FFFF",fillColor:a.regions.colorMap[d.properties.IO_ID],weight:1,opacity:1,fillOpacity:0.4}},onEachFeature:function(f,e){var d="<b>Район: "+f.properties.NAME+"</b></br>Избирательный округ №"+f.properties.IO_ID+"</br>OKATO: "+f.properties.OKATO+"</br>OKTMO: "+f.properties.OKTMO;e.bindPopup(d)}})},bordersDistrictsLayer:null,buildBordersDistrictsLayer:function(c){this.bordersDistrictsLayer=L.geoJson(c,{style:function(d){return{color:"#0000FF",weight:1,opacity:1,fillOpacity:0}}})},bindRegionLayersEvent:function(){var c=this;a.viewmodel.map.on("moveend",function(g){var f=g.target,d=f.getZoom();c.verifyLayersByZoom(d)})},verifyLayersByZoom:function(c){if(!c){c=a.viewmodel.map.getZoom()}if(c>14){a.viewmodel.map.removeLayer(this.regionsLayer)}else{a.viewmodel.map.addLayer(this.regionsLayer);this.regionsLayer.bringToBack()}}})})(jQuery,NGC);(function(b,a){a.alerts={};b.extend(a.view,{$alerts:null});b.extend(a.viewmodel,{alerts:{}});b.extend(a.alerts,{alerts:{historyShortcuts:{id:"historyShortcuts",type:"info",text:"Пожалуйста, не используйте данные с других карт!",statusText:"Мы создаем открытые данные без нарушений чужих лицензионных соглашений."},zoom:{id:"zoom",type:"alert",text:"Увеличьте масштаб для отображения объектов",statusText:"Мелкий масштаб!"},saveSuccessful:{id:"saveSuccessful",type:"info",text:"Объект успешно обновлен",statusText:""},saveError:{id:"saveError",type:"error",text:"Ошибка - объект не обновлен.",statusText:"Ошибка!"},changeCoordinates:{id:"coodrinateChanged",type:"info",text:"После изменения координаты должны быть применены.",statusText:"Внимание! "},notAppliedCoordinates:{id:"notAppliedCoordinates",type:"error",text:"Вы не применили координаты к редактируемому объекту. ",statusText:"Ошибка сохранения:"},validateCoordinatesError:{id:"valCoordError",type:"error",text:"Десятичные градусы должны быть введены как 58.00000",statusText:"Неправильный формат ввода координат:"},regeocodeSuccess:{id:"regeocodeSuccess",type:"info",text:"координаты обновлены",statusText:"Геокодирование завершилось успешно:"},regeocodeFail:{id:"regeocodeFail",type:"error",text:"координаты не были обновлены",statusText:"Адрес не был геокодирован:"},creatorFail:{id:"creatorFail",type:"error",text:"зарегистрируйтесь и авторизуйтесь, пожалуйста",statusText:"Создавать новые объекты нельзя:"}},init:function(){a.view.$alerts=b("#alerts")},showAlert:function(d){if(!this.alerts[d]||a.viewmodel.alerts[d]){return false}a.viewmodel.alerts[d]=true;var c=a.templates.alertsTemplate(this.alerts[d]);a.view.$alerts.append(c);b("#alert_"+this.alerts[d].id).fadeIn().delay(2000).fadeOut("slow",function(){b(this).remove();a.viewmodel.alerts[d]=false})}})})(jQuery,NGC);(function(b,a){b.extend(a.viewmodel,{isAuth:false});b.extend(a.view,{$userContainer:null,$signInForm:null,$signOutForm:null});a.user={};b.extend(a.user,{init:function(){this.setDomOptions();this.handleFirstUser()},setDomOptions:function(){a.view.$userContainer=b("#userContainer");a.view.$signInForm=b("#signInForm");a.view.$signOutForm=b("#signOutForm");if(a.view.$userContainer.hasClass("inner")){a.viewmodel.isAuth=true}},handleFirstUser:function(){var c=b.cookie("ngc.user.known");if(!c){b.cookie("ngc.user.known","True",{expires:200,path:"/"});a.view.$document.on("/ngc/popup/welcome/opened",function(){b("#welcomePopup div.start input").off("click").on("click",function(){a.view.$document.trigger("/ngc/popup/closePopup");b(this).unbind("click")})});a.view.$document.trigger("/ngc/popup/openPopup",["Добро пожаловать!",a.templates.welcomeTemplate({rootUrl:document.url_root,first:true}),"welcome"])}}})})(jQuery,NGC);(function(b,a){b.extend(a.view,{$permalink:null,$fb_link:null});a.permalink={};b.extend(a.permalink,{init:function(){this.setDomOptions();this.bindEvents()},setDomOptions:function(){a.view.$permalink=b("#permalink");a.view.$fb_link=b("#rightPanel a.facebook")},bindEvents:function(){a.view.$document.on("/ngc/permalink/update",function(f,g,e){var c=a.view,d=document.url_root+"?lat="+g.lat+"&lon="+g.lng+"&zoom="+e;c.$permalink.prop("href",d);c.$fb_link.prop("href","https://www.facebook.com/sharer/sharer.php?u="+d)})}})})(jQuery,NGC);(function(b,a){b.extend(a.viewmodel,{});b.extend(a.view,{$josmLink:null});a.josm={};b.extend(a.josm,{init:function(){this.bindEvents();this.setDomOptions()},setDomOptions:function(){a.view.$josmLink=b("#josm-link")},bindEvents:function(){b("#json_link").on("mouseover",function(){var d=a.viewmodel.map.getBounds(),c=("http://127.0.0.1:8111/load_and_zoom?left="+d.getNorthWest().lng+"&top="+d.getNorthWest().lat+"&right="+d.getSouthEast().lng+"&bottom="+d.getSouthEast().lat);b(this).attr("href",c)})}})})(jQuery,NGC);(function(b,a){b.extend(a.viewmodel,{version:null});b.extend(a.view,{$divVersions:null});a.versions={};b.extend(a.versions,{init:function(){this.setDomOptions();this.bindEvents()},setDomOptions:function(){a.view.$divVersions=b("#versionsEntity")},bindEvents:function(){var c=this;a.view.$document.on("/ngc/versions/build",function(){c.buildVersions()});a.view.$document.on("/ngc/versions/clearUI",function(){c.clearVersionsUI()})},buildVersions:function(){a.view.$divVersions.empty();if(a.viewmodel.entitySelected.versions&&a.viewmodel.entitySelected.versions.length>0){for(var e in a.viewmodel.entitySelected.versions){var c=a.viewmodel.entitySelected.versions[e];var d=a.templates.versionsTemplate({num:+e+1,name:c.display_name,time:c.time});a.view.$divVersions.append(d)}}else{a.view.$divVersions.append("У этого УИКа нет сохраненных версий")}},clearVersionsUI:function(){a.view.$divVersions.empty()}})})(jQuery,NGC);(function(b,a){b.extend(a.viewmodel,{});b.extend(a.view,{$activatedEditorTab:null});a.editor.tab={};b.extend(a.editor.tab,{init:function(){this.setDomOptions();this.bindEvents()},setDomOptions:function(){a.view.$activatedEditorTab=a.view.$editorContainer.find("ul.nav li.active")},bindEvents:function(){var c=this,d;a.view.$editorContainer.find("ul.nav li").off("click").on("click",function(f){d=b(this);if(d.data("id")!==a.view.$activatedEditorTab.data("id")){c.activateTab(d)}})},activateTab:function(d){var c=a.view;c.$activatedEditorTab.removeClass("active");c.$activatedEditorTab=d.addClass("active");c.$editorContainer.attr("class",d.data("id"))}})})(jQuery,NGC);NGC.templates={};NGC.templates.entityPopupTemplate=Mustache.compile('<div id="entity-popup" class="{{css}} loader"></div>');NGC.templates.alertsTemplate=Mustache.compile('<div id="alert_{{id}}" class="alert alert-{{type}}" style="display: none;"> <button type="button" class="close" data-dismiss="alert">&times;</button> <strong>{{statusText}}</strong> {{text}} </div>');NGC.templates.versionsTemplate=Mustache.compile("<ul> <li> <b>v{{num}}</b> {{time}}, {{name}} </li> </ul>");NGC.templates.entityPopupInfoTemplate=Mustache.compile('<table class="table table-striped"> {{#props}} <tr> <td>{{title}}</td> {{#text}} <td>{{text}}</td> {{/text}} {{^text}} <td>{{val}}</td> {{/text}} </tr> {{/props}} <tr> <td>Проверен</td> <td> {{#obj.approved}}Да{{/obj.approved}} {{^obj.approved}}Нет{{/obj.approved}} </td> </tr> {{#isBlocked}} <tr class="block"> {{#isUnBlocked}} <td>Заблокирована вами</td> <td> <button class="btn btn-small btn-primary block" id="unblock" type="button">Разблокировать</button> </td> {{/isUnBlocked}} {{^isUnBlocked}} <td>Заблокировал</td> <td>{{userBlocked}}</td> {{/isUnBlocked}} </tr> {{/isBlocked}} </table> <div class="edit"> {{#isUserEditor}} <button class="btn btn-small btn-primary {{#isBlock}}block{{/isBlock}}" id="edit" type="button" {{#editDenied}}disabled="disabled"{{/editDenied}}>Редактировать</button> {{/isUserEditor}} </div>');NGC.templates.osmPopupTemplate=Mustache.compile('<div class="osm-popup"> <div class="caption"> <span>{{id}}</span> <a href="{{link}}" target="_blank" title="Посмотреть на OpenStreetMaps" class="osm"></a> </div> <table class="table table-striped"> {{#tags}} <tr> <td>{{key}}</td> <td>{{val}}</td> </tr> {{/tags}} </table> </div>');NGC.templates.addressSearchTemplate=Mustache.compile('<ul class="{{cssClass}}"> {{#matches}} <li data-lat={{lat}} data-lon={{lon}} data-id={{id}}> {{display_name}} <a class="target" title="Перейти к объекту"></a> </li> {{/matches}} </ul>');NGC.templates.welcomeTemplate=Mustache.compile('<div id="welcomePopup"> <p><strong>Здесь вы можете помочь проверить информацию по местоположениям объектов.</strong></p> <p>Чтобы начать работу - <a target="_blank" href="{{rootUrl}}register">зарегистрируйтесь</a> и найдите интересный вам участок или непроверенные объекты.</p> <p>Полезные ссылки:</p> <ul> <li><a target="_blank" href="http://nextgis.github.io/nextgiscrowd/">Руководство пользователя редактора</a></li> <li><a target="_blank" href="http://gis-lab.info/qa/uikgeo.html">О проекте</a></li> <li><a target="_blank" href="https://github.com/nextgis/nextgiscrowd">Исходный код</a></li> <li><a target="_blank" href="https://github.com/nextgis/nextgiscrowd/wiki/%D0%9A%D0%B0%D0%BA-%D1%8D%D1%82%D0%BE-%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%B0%D0%B5%D1%82">Как это работает</a></li> <li>Обратная связь: <a a target="_blank" href="http://nextgis.ru/contact/">здесь</a></li> </ul> <p><strong>Пожалуйста, не используйте данные с других карт!</strong></p> {{#first}} <div class="start"> <input type="button" class="btn btn-primary" value="Начать работу!"/> </div> {{/first}} </div> ');NGC.templates.searchResultsTemplate=Mustache.compile('<ul class="{{cssClass}}"> {{#entities}} <li data-lat={{lat}} data-lon={{lon}} data-id={{id}}> <span>{{name}}</span> {{addr}} <a class="target" title="Перейти"></a> {{#isAuth}}<a class="edit" title="Редактировать"></a>{{/isAuth}} </li> {{/entities}} </ul>');NGC.templates.userLogsTemplate=Mustache.compile('<table class="table table-striped logs"> <caption>Общая статистика</caption> <tr> <th>Показатель</th> <th>Значение</th> </tr> <tr> <td>Всего объектов</td> <td class="stop">{{count_all}}</td> </tr> <tr> <td>Отредактировано объектов</td> <td class="stop">{{count_editable}}</td> </tr> <tr> <td>Отредактировано, %</td> <td class="stop">{{percent}}</td> </tr> </table> <table class="table table-striped logs"> <caption>Статистика по пользователям</caption> <tr> <th>Пользователь</th> <th>Кол-во объектов</th> </tr> {{#user_logs}} <tr> <td>{{user_name}}</td> <td class="stop">{{count_entities}}</td> </tr> {{/user_logs}} </table>');